 ...
 */
public class ConcreteDecoratorB extends GunDec
{
    /**
     * Act - do whatever the ConcreteDecoratorB wants to do. This method is called whenever
     * the 'Act' or 'Run' button gets pressed in the environment.
     */
    public ConcreteDecoratorB(Weapon gun) {
        super(gun);
    ...
    public void addPower() {
        getWorld().addObject(new Shot(45, gun), getX(), getY());
        getWorld().addObject(new Shot(-45, gun), getX(), getY());
    }
